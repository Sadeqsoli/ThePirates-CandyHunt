...
public class Level097 : MonoBehaviour
{
    ...
    private float currentTime = 90.99f;
    private const int levelUnlocked = 121;
    ...
    {
        Timer();
        if (gameLog.JunkCandyCrossed >= 9 && gameLog.motherEnemyShipDistroyed >= 3 && gameLog.unitEnemyShipDistroyed >= 5
            && gameLog.coins > 60 && isFinished == true && !OnlyOnec)
        {
            WinPanelPopup();
            OnlyOnec = true;
        }
