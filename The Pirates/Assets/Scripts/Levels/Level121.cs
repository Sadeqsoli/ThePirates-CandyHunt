...
public class Level121 : MonoBehaviour
{
    ...
    private float currentTime = 105.99f;
    private const int levelUnlocked = 145;
    ...
    {
        Timer();
        if (gameLog.JunkCandyCrossed >= 10 && gameLog.motherEnemyShipDistroyed >= 3 && gameLog.unitEnemyShipDistroyed >= 6
            && gameLog.coins > 70 && isFinished == true && !OnlyOnec)
        {
            WinPanelPopup();
            OnlyOnec = true;
        }
