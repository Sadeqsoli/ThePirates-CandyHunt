...
public class Level169 : MonoBehaviour
{
    ...
    private float currentTime = 135.99f;
    private const int levelUnlocked = 193;
    ...
    {
        Timer();
        if (gameLog.JunkCandyCrossed >= 10 && gameLog.motherEnemyShipDistroyed >= 3 && gameLog.unitEnemyShipDistroyed >= 8
            && gameLog.coins > 90 && isFinished == true && !OnlyOnec)
        {
            WinPanelPopup();
            OnlyOnec = true;
        }
