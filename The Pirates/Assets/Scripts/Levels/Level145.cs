...
public class Level145 : MonoBehaviour
{
    ...
    private float currentTime = 120.99f;
    private const int levelUnlocked = 169;
    ...
    {
        Timer();
        if (gameLog.JunkCandyCrossed >= 10 && gameLog.motherEnemyShipDistroyed >= 3 && gameLog.unitEnemyShipDistroyed >= 7
            && gameLog.coins > 80 && isFinished == true && !OnlyOnec)
        {
            WinPanelPopup();
            OnlyOnec = true;
        }
