...
public class Level01 : MonoBehaviour
{
    ...
    private float currentTime = 30.99f;
    private const int levelUnlocked = 25;
    ...
    {
        Timer();
        if (gameLog.JunkCandyCrossed >= 3 && gameLog.motherEnemyShipDistroyed >= 1 && gameLog.coins > 5 && isFinished == true && !OnlyOnec)
        {
            WinPanelPopup();
            OnlyOnec = true;
        }
