...
public class Powerdown_DoubleEnemyship : MonoBehaviour
{
    ...
    {
        Instantiate(pickupEffect, new Vector2(-2, 4) , Quaternion.identity);
        Instantiate(pickupEffect, new Vector2(2, 4) , Quaternion.identity);
        //dynamic
        Instantiate(enemyship, new Vector2(-3, 5), Quaternion.identity);
        Instantiate(enemyship, new Vector2(3, 5), Quaternion.identity);
        TrailSpawn();
